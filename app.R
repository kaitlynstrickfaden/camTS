                ...
                sidebarLayout(
                  ...
                  sidebarPanel(
                    ...
                    selectInput(inputId = "var",
                                label = "Response",
                                choices = c("SnowDepth", "Temperature"),
                                selected = "SnowDepth"
                    ),
...
server <- function(input, output, session) {
  ...
  output$clickplot <- renderPlotly({
    ...
    hdat <- highlight_key(dat, ~image_url)
  ...
  observeEvent(doubleclick_event(), {
    ...
    output$table <- renderDataTable({
      #req(event_data("plotly_doubleclick"))
      dat %>% 
        filter(customdata == doubleclick_event()$customdata)
    })
